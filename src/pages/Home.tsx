...
import { ArrowRight, Globe, Zap, Gamepad2, Code2, Box, Image as ImageIcon, type LucideIcon } from "lucide-react";
import { useNavigate } from "react-router-dom";

const FEATURES: { title: string; desc: string; icon: LucideIcon }[] = [
  { title: "Websites", desc: "Portfolios, landing pages, blogs", icon: Globe },
  { title: "Web Apps", desc: "Dashboards, tools, utilities", icon: Zap },
  { title: "2D Games", desc: "Canvas games, puzzles, arcades", icon: Gamepad2 },
  { title: "3D Games", desc: "Three.js worlds, 3D engines", icon: Box },
  { title: "AI Images", desc: "Generate images from text", icon: ImageIcon },
...
const QUICK_START = [
  ...
  { label: "Pomodoro Timer", prompt: "Make a beautiful Pomodoro timer app with stats, sounds, and dark theme" },
];
